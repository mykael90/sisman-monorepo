...
export type IWarehouseStockWithRelations = Prisma.MaterialWarehouseStockGetPayload<{
  include: {}
}>;

export interface IWarehouseStockAdd extends Omit<Prisma.MaterialWarehouseStockCreateInput, 
