...
import { IItemPickingOrderMaterialRequestForm } from '../card-material-link-details';
...
interface TableFormItemsMaterialRequestProps {
  materialsInfo: IItemPickingOrderMaterialRequestForm[];
...
export function TableFormItemsMaterialRequest({
  ...
  const infoMap = useMemo(() => {
    const map = new Map<number, IItemPickingOrderMaterialRequestForm>();
  ...
  const getClampedQuantity = (
    material: IItemPickingOrderMaterialRequestForm,
    newQuantity: number
  ): number => {
                    ...
                    {readOnly ? (
                      ...
                      <div className='flex items-center justify-center gap-2'>
                        ...
                        <Button
                          ...
                          disabled={
                            isFreeBalanceDefined &&
                            Number(material.quantityToPick) >= balancePotential
                          }
                        >
