...
export function MaterialPickingOrderFormBulk({
  defaultData,
  ...
  const [maintenanceRequestData, setMaintenanceRequestData] =
    useState<IMaintenanceRequestBalanceWithRelations | null>(
      defaultDataMaterialPickingOrder.maintenanceRequestData
    );

  const [materialRequestData, setMaterialRequestData] =
    useState<IMaterialRequestBalanceWithRelations | null>(
      defaultDataMaterialPickingOrder.materialRequestData
    );

  const [materialRequestBalance, setMaterialRequestBalance] =
    useState<IMaterialRequestBalanceWithRelationsForm | null>(
      defaultDataMaterialPickingOrder.materialRequestBalance
    );

  const [linkMaterialRequest, setLinkMaterialRequest] = useState<boolean>(true);
