...
export type IItemPickingOrderMaterialRequestForm = Pick<
...
export type IMaterialRequestBalanceWithRelationsForm = Omit<
  ...
  'itemsBalance'
> & {
  itemsBalance: IItemPickingOrderMaterialRequestForm[];
};
...
export function CardMaterialRequestLinkDetails({
  ...
  formPickingOrder: IPickingOrderFormApi;
  materialRequestDataLinked: any;
  setFieldValue: IPickingOrderFormApi['setFieldValue'];
