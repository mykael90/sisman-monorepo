...
const columnHelper = createColumnHelper<IUserWithRelations>();
...
export const createActions = (
...
): ActionHandlers<IUserWithRelations> => ({
  onEdit: (row: Row<IUserWithRelations>) => {
  ...
  onDelete: (row: Row<IUserWithRelations>) => {
...
export const columns = (
  configuredActions: ActionHandlers<IUserWithRelations>
): ColumnDef<IUserWithRelations, any>[] => [
