...
import { getRefreshedWorkerManualFrequencies, getWorkerManualFrequencies } from './worker-manual-frequency-actions';
...
export default async function Page() {
  ...
  const [initialWorkerManualFrequencies] = await Promise.all([getWorkerManualFrequencies(accessTokenSisman)]);
