      ...
      materialWarehouseStock: {
        ...
        freeBalanceQuantity: {
          ...
          compute(stock: {
            ...
            restrictedQuantity: Prisma.Decimal | null;
          }): Prisma.Decimal | null {
            // <-- O retorno agora também pode ser nulo
            ...
            // Ainda tratamos 'balanceInMinusOut' como potencialmente nulo, convertendo-o para zero se necessário.
            const balance = stock.balanceInMinusOut ?? new Prisma.Decimal(0);
            const reserved = stock.reservedQuantity ?? new Prisma.Decimal(0);
            const restricted =
              stock.restrictedQuantity ?? new Prisma.Decimal(0);

            // A soma agora é segura.
            return stock.initialStockQuantity
              .add(balance)
              .minus(reserved)
              .minus(restricted);
          }
