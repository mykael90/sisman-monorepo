...
export class CreateOccurrenceReinforcementDto
  implements
    Omit<
      Prisma.OccurrenceReinforcementCreateManyInput,
      'occurrenceId' | 'userId'
    >
{
  @ApiProperty({
...
export class CreateOccurrenceReinforcementWithRelationsDto extends CreateOccurrenceReinforcementDto {
  @ApiProperty({
...
export class UpdateOccurrenceReinforcementDto extends PartialType(
  CreateOccurrenceReinforcementDto
) {
  @ApiProperty({
...
export class UpdateOccurrenceReinforcementWithRelationsDto extends PartialType(
  CreateOccurrenceReinforcementWithRelationsDto
) {}
