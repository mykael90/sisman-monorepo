...
import { CreateMaterialWithdrawalWithRelationsDto } from '../../material-withdrawals/dto/material-withdrawal.dto';
...
export class MaterialWithdrawalMapper {
  ...
  async toCreateDto(
  ...
  ): Promise<CreateMaterialWithdrawalWithRelationsDto> {
    ...
    return {
      ...
      // o valor é calculado dentro do serviço de withdrawal
