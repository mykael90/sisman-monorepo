...
import { UpdateMaintenanceRequestDto } from '../maintenance-requests/maintenance-request.dto';

export class CreateInfrastructureOccurrenceDiagnosisDto
  implements
    Omit<
      Prisma.InfrastructureOccurrenceDiagnosisCreateManyInput,
      'occurrenceId' | 'analyzedById'
    >
{
  @ApiProperty({
  ...
  @ApiProperty({
    ...
    example: $Enums.DiagnosisOutcome.CREATED_REQUEST,
    required: false
  })
  @IsOptional()
...
export class CreateInfrastructureOccurrenceDiagnosisWithRelationsDto extends CreateInfrastructureOccurrenceDiagnosisDto {
  @ApiProperty({
...
export class UpdateInfrastructureOccurrenceDiagnosisDto extends PartialType(
  CreateInfrastructureOccurrenceDiagnosisDto
) {
  @ApiProperty({
...
export class UpdateInfrastructureOccurrenceDiagnosisWithRelationsDto extends PartialType(
  CreateInfrastructureOccurrenceDiagnosisWithRelationsDto
) {}
