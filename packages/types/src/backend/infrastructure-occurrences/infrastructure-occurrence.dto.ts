...
import { UpdateUserDto } from '../users/user.dto'; // Assuming User DTO exists
...
import { UpdateInfrastructureOccurrenceReinforcementDto } from '../infrastructure-occurrence-reinforcements/infrastructure-occurrence-reinforcement.dto';
