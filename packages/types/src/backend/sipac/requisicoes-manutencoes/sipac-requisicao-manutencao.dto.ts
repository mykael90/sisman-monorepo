import { PartialType } from '@nestjs/swagger'; // Alterado de @nestjs/mapped-types
import {
  IsString,
  IsNotEmpty,
  IsOptional,
...
export class CreateSipacListaRequisicaoManutencaoDto {
  ...
  /**
   * Usuário que gravou a requisição
...
export class SipacInformacoesDoServicoManutencaoDto {
  /**
   * ID da requisição de manutenção pai
   * @example 1
   */
  ...
  /**
   * Executante do serviço (ex: "(Engenheiro )")
   * @example "(Engenheiro )"
   */
  @IsNotEmpty()
  @IsString()
  ...
  /**
   * Data de cadastro do serviço (ex: "27/03/2025")
  ...
  /**
   * Técnico responsável (ex: "JOAO PAULO FELIPE PINTO")
   * @example "JOAO PAULO FELIPE PINTO"
   */
  @IsNotEmpty()
  @IsString()
...
export class SipacRequisicaoManutencaoMaeAssociadaDto {
  /**
   * Número/ano da requisição associada (ex: "631/2024")
   * @example "631/2024"
   */
  @IsNotEmpty()
  @IsString()
  ...
  /**
   * Descrição da requisição associada
   * @example "Acessórios e ferramentas necessários..."
   */
  @IsNotEmpty()
  @IsString()
  ...
  /**
   * Data de cadastro da requisição associada (ex: "02/02/2024")
...
export class SipacItemRequisicaoMaterialManutencaoDto {
  /**
   * ID da requisição de material associada pai
   * @example 1
   */
  @IsOptional() // Made optional as it will be set by parent
  @IsNumber()
  ...
  /**
   * Material (ex: "302400009390 - BALDE DE FERRO - 10 LITROS")
...
export class SipacRequisicaoMaterialAssociadaManutencaoDto {
  ...
  /**
   * Número da requisição (ex: "16689/2025")
   * @example "16689/2025"
   */
  @IsNotEmpty()
  @IsString()
  ...
  /**
   * Data de cadastro (ex: "06/06/2025")
  ...
  /**
   * Status (ex: "AGUARD. AUTORIZAÇÃO ORÇAMENTÁRIA")
  ...
  /** Lista de itens da requisição de material */
  @IsArray()
  @ValidateNested({ each: true })
  ...
  /**
   * Total de quantidade do grupo (ex: "3,0")
   * @example "3,0"
   */
  @IsNotEmpty()
  @IsString()
  ...
  /**
   * Total de valor calculado do grupo (ex: "R$ 61,60")
   * @example 61.60
   */
  @IsNotEmpty()
  @IsDecimal({ decimal_digits: '2' })
  ...
  /**
   * Total de valor total do grupo (ex: "R$ 61,60")
   * @example 61.60
   */
  @IsNotEmpty()
  @IsDecimal({ decimal_digits: '2' })
...
export class SipacImovelPredioManutencaoDto {
  ...
  /**
   * Imóvel/Terreno (ex: "CAMPUS UNIVERSITÁRIO - AREA II")
   ...
   * @example "ADM. CENTRAL - SIN/DIMAN - DIRETORIA DE MANUTENÇÃO - MANUTEÇÃO DE INSTALAÇÕES"
   */
  @IsNotEmpty()
  @IsString()
  predio: string;
...
export class SipacHistoricoManutencaoDto {
  ...
  /**
   * Status do evento (ex: "CADASTRADA")
   * @example "CADASTRADA"
   */
  @IsNotEmpty()
  @IsString()
...
export class CreateSipacRequisicaoManutencaoCompletoDto extends CreateSipacListaRequisicaoManutencaoDto {
  ...
  /**
   * Data de cadastro (ex: "27/03/2025")
   * @example "2025-03-27T00:00:00.000Z"
   */
  @IsNotEmpty()
  @Type(() => Date)
  ...
  /**
   * Nome do predio
   * @example "Nome do Prédio Exemplo"
   */
  @IsNotEmpty()
  @IsString()
  nomePredio: string;
  ...
  /**
   * Telefones do representante (ex: "84991676560")
   * @example "84991676560"
   */
  @IsOptional()
  @IsString()
  ...
  /**
   * Email do representante (ex: "jonatasufrn@yahoo.com")
  ...
  /**
   * Horário para atendimento (ex: "07H00-16H00")
   * @example "07H00-16H00"
   */
  @IsOptional()
  @IsString()
  ...
  /** Requisições de manutenção associadas */
  @IsOptional()
  ...
  /** Requisições de materiais associadas */
  @IsArray()
  @IsOptional()
  @ValidateNested({ each: true })
  ...
  /** Histórico da requisição de manutenção */
  @IsOptional()
  @IsArray()
  @ValidateNested({ each: true })
